        ...
        <div className="container mx-auto max-w-7xl px-4 py-10">
          <div className="text-center py-20 border border-dashed border-red-500/30 rounded-2xl">
            ...
            <p className="text-muted-foreground max-w-md mx-auto mb-4">
              A tabela de mangás não foi encontrada. Rode a migration:
            </p>
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {rows.length} {rows.length === 1 ? "obra" : "obras"} disponíveis
          </p>
        </div>
      </div>
      ...
      {rows.length === 0 ? (
        <div className="text-center py-20 border border-dashed border-border/40 rounded-2xl">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Nenhum mangá importado ainda. Execute:
          </p>
          <code className="bg-muted px-3 py-1 rounded text-sm mt-2 inline-block">
            npm run import:mangaonline &lt;slug&gt;
          </code>
        </div>
      ) : (
