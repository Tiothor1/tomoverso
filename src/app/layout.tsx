    ...
    >
      <head>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `(function(){try{var s=JSON.parse(localStorage.getItem('tomoverso-ui-theme')||'{}');var themes=['dark','light','system'];var colors=['purple','blue','rose','amber'];var pref=themes.indexOf(s.theme)>=0?s.theme:'dark';var hasSub=/(?:^|; )tomoverso-subscriber=1(?:;|$)/.test(document.cookie);var rawColor=colors.indexOf(s.color)>=0?s.color:(s.color==='sepia'?'amber':'purple');var color=(rawColor==='purple'||hasSub)?rawColor:'purple';var resolved=pref==='system'?(window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light'):pref;document.documentElement.classList.remove('light','dark');document.documentElement.classList.add(resolved);document.documentElement.setAttribute('data-theme',pref);document.documentElement.setAttribute('data-color',color);document.documentElement.lang='pt-BR';document.documentElement.setAttribute('data-locale','pt');document.documentElement.setAttribute('data-translation-status','ready');}catch(e){document.documentElement.classList.add('dark');document.documentElement.setAttribute('data-theme','dark');document.documentElement.setAttribute('data-color','purple');document.documentElement.lang='pt-BR';document.documentElement.setAttribute('data-locale','pt');document.documentElement.setAttribute('data-translation-status','ready');}})()`
        }} />
      </head>
