...
export const mockAuthor: Author = {
  id: "fabio-tx",
  username: "fabio_tx",
  display_name: "Fábio Teixeira",
  avatar_url: undefined,
  bio: "Criador do Tomoverso. Escritor de Light Novels. Apaixonado por anime, fandub e mundos que ainda não existem.",
  created_at: "2026-06-19T00:00:00Z",
};

// ===== Novel piloto: "O Que Eu Desenhei, Existe" =====
...
// ===== Capítulos piloto (escritos por IA, pra exemplo) =====
...
// ===== Novel mock secundária (pra catálogo ter mais coisa) =====
export const mockNovels: Novel[] = [
  mockNovel,
  {
    ...
    synopsis:
      "Diego, dublador brasileiro de anime, morre e acorda num mundo medieval em guerra — onde sua habilidade de imitar qualquer voz é a arma mais poderosa que existe.",
    cover_url: "/covers/dublador-cover.jpg",
    author_id: "fabio-tx",
    author: mockAuthor,
    type: "light-novel",
    status: "ongoing",
  ...
  },
  {
    ...
    synopsis:
      "Kai é o único caçador preso no rank mais baixo por uma década. Até que copia, sem querer, a habilidade do monstro mais forte que existe.",
    cover_url: "/covers/sistema-cover.jpg",
    author_id: "fabio-tx",
    author: mockAuthor,
    type: "light-novel",
    status: "ongoing",
