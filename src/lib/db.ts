...
function createDb() {
  ...
  db.exec(`
    ...
    VALUES
      ('leitor-monthly', 'Leitor', 'Chega de anuncios. Badge exclusivo e tema sepia pra leitura mais confortavel.', 990, 'month', '[\\\"Zero anuncios no site inteiro\\\",\\\"Badge Leitor em comentarios\\\",\\\"Tema sepia para leitura\\\",\\\"Suporte via e-mail prioritario\\\"]', 'subscriber', 'Leitor', 1),
