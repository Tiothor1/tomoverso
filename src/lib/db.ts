...
function createDb() {
  ...
  db.exec(`
    ...
    VALUES
      ...
      ('pro-monthly', 'Pro', 'Experiencia premium para leitores e autores: baixar capitulos, temas e badge dourado.', 1990, 'month', '["Zero anuncios no site inteiro","Badge Pro dourado em comentarios e perfil","Baixar capitulos em .txt para ler offline","Modo leitura premium","Cores exclusivas","Comentario com destaque","Suporte prioritario via WhatsApp"]', 'subscriber', 'Pro', 2),
      ('pro-yearly', 'Pro Anual', 'Tudo do Pro com 3 meses gratis. Pague 9 meses e leve 12.', 17900, 'year', '["Todos os beneficios do Pro","3 meses gratis","Menos de R$ 15 por mes"]', 'subscriber', 'Pro', 3),
      ('author-monthly', 'Autor+', 'Ferramentas profissionais para criar, polir e divulgar obras. Publicar continua gratis para todos.', 2990, 'month', '["Central de ideias para premissas, personagens, poderes e arcos","Assistente editorial para titulo, sinopse, tags e gancho","Pack de assets com capas, banners, divisorias, fichas e prompts","Trilhas guiadas para criar sua primeira obra","Estatisticas avancadas de autor","Perfil premium com selo Autor+","Destaque leve de descoberta sem bloquear autores gratuitos"]', 'author', 'Autor+', 4);

    UPDATE subscription_plans SET description = 'Ferramentas profissionais para criar, polir e divulgar obras. Publicar continua gratis para todos.', name = 'Autor+', badge_label = 'Autor+', role_granted = 'author', features = '["Central de ideias para premissas, personagens, poderes e arcos","Assistente editorial para titulo, sinopse, tags e gancho","Pack de assets com capas, banners, divisorias, fichas e prompts","Trilhas guiadas para criar sua primeira obra","Estatisticas avancadas de autor","Perfil premium com selo Autor+","Destaque leve de descoberta sem bloquear autores gratuitos"]' WHERE id = 'author-monthly';
    UPDATE subscription_plans SET features = REPLACE(features, 'Obras ilimitadas', 'Publicacao gratuita ja e ilimitada') WHERE id IN ('pro-monthly','pro-yearly');
