...
function createDb() {
  ...
  db.exec(`
    ...
    VALUES
      ('pro-monthly', 'Tomoverso Pro', 'Leitura VIP completa: sem anuncios, baixe capitulos em PDF, personalize o leitor e tenha badge exclusivo.', 990, 'month', '[\\\"Zero anuncios no site inteiro\\\",\\\"Baixar capitulos em PDF para ler offline\\\",\\\"Modo leitura premium (fonte, espacamento, cor da pagina)\\\",\\\"Badge Pro em comentarios e perfil\\\",\\\"Biblioteca ilimitada (favoritos e progresso)\\\",\\\"Temas de cor exclusivos para o site\\\",\\\"Comentario com destaque dourado\\\",\\\"Suporte prioritario via WhatsApp\\\",\\\"Participe de votacoes: escolha o proximo manga\\\"]', 'subscriber', 'Pro', 1),
      ('pro-yearly', 'Tomoverso Pro Anual', 'Todos os beneficios do Pro com 2 meses gratis. Economia de R$ 23,80 por ano.', 9490, 'year', '[\\\"Zero anuncios no site inteiro\\\",\\\"Baixar capitulos em PDF para ler offline\\\",\\\"Modo leitura premium (fonte, espacamento, cor da pagina)\\\",\\\"Badge Pro em comentarios e perfil\\\",\\\"Biblioteca ilimitada (favoritos e progresso)\\\",\\\"Temas de cor exclusivos para o site\\\",\\\"Comentario com destaque dourado\\\",\\\"Suporte prioritario via WhatsApp\\\",\\\"Participe de votacoes: escolha o proximo manga\\\",\\\"2 meses gratis (economia de R$ 23,80)\\\"]', 'subscriber', 'Pro', 2),
      ('author-monthly', 'Tomoverso Autor', 'Tudo do Pro + ferramentas profissionais de publicacao, analytics detalhados e destaque garantido no catalogo.', 1990, 'month', '[\\\"Todos os beneficios do Pro\\\",\\\"Publicacao ilimitada de obras (sem fila de aprovacao)\\\",\\\"Dashboard com analytics: views por capitulo, tempo de leitura, abandono\\\",\\\"Destaque no catalogo por 7 dias a cada obra nova\\\",\\\"Editor avancado com preview e Markdown\\\",\\\"Exportar obra completa em PDF/ePub\\\",\\\"Badge Autor Verificado (azul) em perfil e obras\\\",\\\"Compartilhamento automatico nas redes ao publicar\\\",\\\"Multiplos autores por obra (co-autoria)\\\",\\\"Prioridade em eventos e divulgacoes\\\"]', 'author', 'Autor Verificado', 3);
  `);
