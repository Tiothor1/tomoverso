...
export function NovelCard({
        ...
        <Card className="overflow-hidden hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10">
          <div className="flex gap-4 p-4">
            <div className="w-20 flex-shrink-0">
              <NovelCover novel={novel} className="aspect-[3/4]" />
            </div>
  ...
  return (
    <Link href={`/novels/${novel.slug}`} className="group block">
      <Card className="overflow-hidden h-full hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 duration-300">
        <div className="relative aspect-[3/4] overflow-hidden">
          <NovelCover novel={novel} className="w-full h-full" />
          {/* Overlay de hover */}
